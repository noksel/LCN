...
Компания Moneymail уведомляет вас о том, что с 1 мая 2011 г. в Системе будет введен новый статус "неактивный Пользователь" - такой статус присваивается пользователю, который не дает распоряжения Системе на
осуществление оплаты товаров и/или услуг, и не переуступает свои права требования по денежным обязательствам третьему лицу через Систему Moneymail в течение последовательных 11 (одиннадцати) календарных месяцев ("срок неактивности"). Система будет начислять и взимать с такого неактивного Пользователя денежную сумму в размере 15 (пятнадцати) рублей за каждый календарный месяц, начиная с первого числа месяца, следующего за сроком неактивности, за ведение Учетного счета и поддержания работоспособности Пользовательского интерфейса.

При этом удержание в указанном размере денежной суммы будет осуществляться ежемесячно, в первый рабочий день месяца, следующего за сроком неактивности. С Учетного счета такого неактивного Пользователя до момента - что наступит ранее - возобновления пользования услугами Системы либо до полного списания денежных средств с учетного счета неактивного Пользователя...Уважаемые пользователи!
Компания Moneymail уведомляет вас о том, что с 1 мая 2011 г. в Системе будет введен новый статус "неактивный Пользователь" - такой статус присваивается пользователю, который не дает распоряжения Системе на
осуществление оплаты товаров и/или услуг, и не переуступает свои права требования по денежным обязательствам третьему лицу через Систему Moneymail в течение последовательных 11 (одиннадцати) календарных месяцев ("срок неактивности"). Система будет начислять и взимать с такого неактивного Пользователя денежную сумму в размере 15 (пятнадцати) рублей за каждый календарный месяц, начиная с первого числа месяца, следующего за сроком неактивности, за ведение Учетного счета и поддержания работоспособности Пользовательского интерфейса.
...
При этом удержание в указанном размере денежной суммы будет осуществляться ежемесячно, в первый рабочий день месяца, следующего за сроком неактивности. С Учетного счета такого неактивного Пользователя до момента - что наступит ранее - возобновления пользования услугами Системы либо до полного списания денежных средств с учетного счета неактивного Пользователя...%s
		</body>
		</html>		
